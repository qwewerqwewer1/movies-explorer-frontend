    ...
    <section className="project">
      <div className="project__container">
        ...
        <div className="project__steps">
          <p className="project__step project__step-one">1 неделя</p>
          <p className="project__step project__step-four">4 недели</p>
          <p className="project__step project__description-backend">Back-end</p>
          <p className="project__step project__description-frontend">Front-end</p>
        </div>
      </div>
    </section>
  )
